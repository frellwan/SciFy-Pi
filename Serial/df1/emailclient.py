...
#d = sendEmail('4109@commscope.com', '8282282123@txt.att.net', 'this is a message', 'this is a test subject')
#d = sendEmail('4109@commscope.com', 'erice@commscope.com', 'this is a message', 'this is a test subject')
